            ...
            <AuthTabs defaultValue="student">
              ...
              <TabsContent value="teacher">
                ...
                >
                  ...
                  <form className="space-y-6">
                    {/* Teacher login form fields would go here */}
                  </form>
                </motion.div>
              </TabsContent>
            </AuthTabs>
            ...
            <div className="space-y-8">
              ...
              >
                <blockquote className="text-gray-700 italic">
                  "The personalized learning experience on Coursa has helped me achieve my career goals faster than I imagined!"
                </blockquote>
                <div className="mt-4 flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Data Science Graduate</div>
                  </div>
                </div>
              </motion.div>
            </div>
